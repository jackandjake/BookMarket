...
<body>
 ...
 <br>
  ...
  <div class="row">
  <div class="col-md-6">    
    <h4 class="tit" id="chk_cont1" style="user-select: auto;">이용약관</h4>
<div class="privercy-contract" style="user-select: auto;">
<textarea cols="80" wrap="off" rows="10" readonly="" style="user-select: auto;">인터넷 쇼핑몰 『주식회사 디이미징 사이버 몰』회원 약관
...
<p class="pl-6 btm-msg" style="user-select: auto;">
                귀하께서는 쇼핑몰에서 위와 같이 수집하는 개인정보에 대해, 동의하지 않거나 개인정보를 기재하지 않음으로써 거부할 수 있습니다.<br style="user-select: auto;">
