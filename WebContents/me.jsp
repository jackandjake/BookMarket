...
<span id="top"></span>
      ...
      <c:if test="${sessionId=='admin'}">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="<c:url value="/editProduct_delete.jsp"/>">상품 삭제</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark">|</a>
        </li>
...
<div class="container mt-2 mb-2" id="banner">
 <div class="row" align="left">
  <div class="col-sm-3">
   <a href="http://localhost:8080/BookMarket/wel.jsp"><img src="/Image/star.png" alt="home" width="100%" height="100%" ></a>
  </div>
  <div class="col-sm-4">
...
<nav class="navbar navbar-expand-sm bg-light">
      <ul class="navbar-nav">
        ...
        <li class="nav-item"  id="mynavbar2-2">
          <a class="nav-link text-dark" href="http://localhost:8080/BookMarket/wel.jsp?#best">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="http://localhost:8080/BookMarket/wel.jsp?#new">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="http://localhost:8080/BookMarket/wel.jsp?#recommend">
